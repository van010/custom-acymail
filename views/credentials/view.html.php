...
class tradingtechnologiesViewCredentials extends ttView {
	...
	function display($tpl = null) {
		...
		//$this->account = ttHelper::getAccount();
		$this->token = ttHelper::getToken();
	...
	protected function addToolBar() {
			JToolBarHelper::title(JText::_('COM_TT_Credentials'), 'tradingtechnologies.png');
			JToolBarHelper::custom('credentials.refreshToken', 'refresh', 'refresh', JText::_('COM_TT_CREDENTIALS_TOKEN_UPDATE'), false);
	}
